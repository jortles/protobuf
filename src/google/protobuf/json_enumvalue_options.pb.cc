...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        ...
        {&::_pbi::kDescriptorMethods, &::descriptor_table_RhC8x4d9MFQ, /* tracker*/ nullptr,},
};
}  // namespace
#endif
namespace pb {
...
constexpr auto JsonEnumValueOptions::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator(&JsonEnumValueOptions::PlacementNew_, sizeof(JsonEnumValueOptions),
                               alignof(JsonEnumValueOptions));
}
constexpr auto JsonEnumValueOptions::InternalGenerateClassData_(
  ...
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetNewImpl<JsonEnumValueOptions>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &JsonEnumValueOptions::SharedDtor,
          ::google::protobuf::Message::GetClearImpl<JsonEnumValueOptions>(), &JsonEnumValueOptions::ByteSizeLong,
...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_RhC8x4d9MFQ = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_RhC8x4d9MFQ = nullptr;
const ::uint32_t
    TableStruct_RhC8x4d9MFQ::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
...
const char descriptor_table_protodef_RhC8x4d9MFQ[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n1third_party/protobuf/json_enumvalue_op"
    "tions.proto\022\014pb.enumvalue\032!net/proto2/pr"
    "oto/descriptor.proto\"(\n\024JsonEnumValueOpt"
    "ions\022\016\n\006string\030\001 \001(\tX\001:S\n\004json\022\030.proto2."
    "EnumValueOptions\030\346\007 \001(\0132\".pb.enumvalue.J"
    "sonEnumValueOptionsB\006\262\001\003\010\217Nb\010editionsp\351\007"
};
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_RhC8x4d9MFQ_deps[1] = {
        &::descriptor_table_bTG6VX9Pz3k,
};
static ::absl::once_flag descriptor_table_RhC8x4d9MFQ_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_RhC8x4d9MFQ = {
    false,
    false,
    240,
    descriptor_table_protodef_RhC8x4d9MFQ,
    "third_party/protobuf/json_enumvalue_options.proto",
    &descriptor_table_RhC8x4d9MFQ_once,
    descriptor_table_RhC8x4d9MFQ_deps,
    1,
    1,
    schemas,
    file_message_globals,
    TableStruct_RhC8x4d9MFQ::offsets,
    file_level_enum_descriptors_RhC8x4d9MFQ,
    file_level_service_descriptors_RhC8x4d9MFQ,
};
namespace pb {
namespace enumvalue {
// ===================================================================
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, JsonEnumValueOptions_get_class_data()) {
...
const char* PROTOBUF_NULLABLE JsonEnumValueOptions::InternalVerify(
    const char* PROTOBUF_NONNULL ptr, ::_pbi::ParseContext* PROTOBUF_NONNULL ctx) {
  static constexpr ::_pbi::LazyEagerVerifyFnTable table[] = {
      {10, &::_pbi::VerifyUtf8String},
      };
  constexpr ::_pbi::VerifyLengthDelimitedOneTag
      vops_length_delimited{table[0].tag,
                            table[0].verify_func};
  return ::_pbi::WireFormatVerify(ptr, ctx, ::_pbi::VerifyInt32NoOp{},
                                  vops_length_delimited,
                                  ::_pbi::VerifyRequiredNoOp{});
}
...
::proto2::Metadata JsonEnumValueOptions::GetMetadata() const {
...
namespace google {
namespace protobuf {
template void* PROTOBUF_NONNULL Arena::DefaultConstruct<::pb::enumvalue::JsonEnumValueOptions>(Arena* PROTOBUF_NULLABLE);
template void* PROTOBUF_NONNULL Arena::CopyConstruct<::pb::enumvalue::JsonEnumValueOptions>(Arena* PROTOBUF_NULLABLE, const void* PROTOBUF_NONNULL);
}  // namespace protobuf
}  // namespace google
// @@protoc_insertion_point(global_scope)
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_RhC8x4d9MFQ),
        ::_pbi::ExtensionSet::RegisterMessageExtension(
            &::google::protobuf::EnumValueOptions::default_instance(), 998, 11,
            false, false, &::pb::enumvalue::JsonEnumValueOptions::default_instance(),
            &::pb::enumvalue::JsonEnumValueOptions::InternalVerify, ::_pbi::LazyAnnotation::kUndefined),
         ::std::false_type{});
